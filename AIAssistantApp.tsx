// AIAssistantApp.tsx — Updated with Dark Mode, Booking History, Calendar Sync, and Location Fallback

import React, { useState, useEffect, useRef } from 'react';
import { Mic, MicOff, Send, Settings, Moon, Sun } from 'lucide-react';

const mockSpaAndAutoProviders = [
  { name: 'Zen Wellness Spa', rating: 4.8, type: 'wellness', distance: '1.2 miles', feedback: 123 },
  { name: 'Bliss Massage Studio', rating: 4.7, type: 'wellness', distance: '0.8 miles', feedback: 89 },
  { name: 'QuickFix Auto Care', rating: 4.9, type: 'automotive', distance: '1.1 miles', feedback: 234 },
];
    ...
    if ('geolocation' in navigator) {
      navigator.geolocation.getCurrentPosition(
        ...
        (err) => {
          ...
          setLocation({ lat: 0, lon: 0 }); // fallback
        },
